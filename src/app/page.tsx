...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-900 via-stone-800 to-stone-900 text-white">
      ...
      {newsItems.length > 0 && (
        <section className="py-8 bg-gradient-to-r from-amber-900/50 to-stone-900 border-y border-amber-500/20">
      ...
      <section id="menu" className="py-20">
        <div className="container mx-auto px-4">
          ...
          {loading ? (<div className="text-center py-12"><div className="animate-spin w-8 h-8 border-4 border-amber-400 border-t-transparent rounded-full mx-auto"></div><p className="mt-4 text-stone-400">{t.menu.loading}</p></div>) : (
